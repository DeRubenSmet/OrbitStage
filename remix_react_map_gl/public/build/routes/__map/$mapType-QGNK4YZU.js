...
var dataLayer = {
  ...
  paint: {
    "fill-color": [
      ...
      [0, "#feb24c", 1e5, "#fd8d3c", 2e5, "#fc4e2a", 3e5, "#e31a1c", 5e5, "#b10026"]
    ],
    "fill-opacity": 1
  }
};
function Test() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, console.log(geojson), /* @__PURE__ */ React.createElement("h2", null, "Hier komt de map ", zoom, " "), /* @__PURE__ */ React.createElement(map_default, {
    id: "map",
    initialViewState: {
      latitude: 50.616949,
      longitude: 4.88526,
...
//# sourceMappingURL=/build/routes/__map/$mapType-QGNK4YZU.js.map
