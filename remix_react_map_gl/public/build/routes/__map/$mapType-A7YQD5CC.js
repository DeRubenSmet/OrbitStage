...
var rangeColors = [0, "#feb24c", 1e5, "#fd8d3c", 2e5, "#fc4e2a", 3e5, "#e31a1c", 5e5, "#b10026", 1e7];
var dataLayer = {
  id: "data",
  type: "fill",
...
function Test() {
  ...
  const mapRef = (0, import_react15.useRef)(null);
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h2", null, "Hier komt de map ", zoom, " "), /* @__PURE__ */ React.createElement(map_default, {
    ref: mapRef,
    id: "map",
    initialViewState: {
      latitude: 50.616949,
...
//# sourceMappingURL=/build/routes/__map/$mapType-A7YQD5CC.js.map
